...
export const CANONICAL_PATHS = [
  ...
  { path: '/nos-services/prix', priority: '0.8', changefreq: 'monthly' },
  { path: '/nos-services/location-bus-groupe', priority: '0.8', changefreq: 'monthly' },
  { path: '/nos-services/autocar-mariage', priority: '0.8', changefreq: 'monthly' },
  { path: '/nos-services/navette-entreprise', priority: '0.8', changefreq: 'monthly' },
  ...
  { path: '/destinations/bruges', priority: '0.8', changefreq: 'weekly' },
  { path: '/destinations/gand', priority: '0.8', changefreq: 'weekly' },
  { path: '/destinations/cologne', priority: '0.7', changefreq: 'weekly' },
