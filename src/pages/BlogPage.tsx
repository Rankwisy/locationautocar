...
const BlogPage: React.FC = () => {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: "Découvrez Amsterdam le temps d'un week-end avec notre guide complet : canaux, musées, quartiers incontournables et bonnes adresses locales.",
      featuredImage: "https://images.pexels.com/photos/1388030/pexels-photo-1388030.jpeg",
      publishedAt: "2024-01-15",
      author: "Location Autocar Bruxelles",
      category: "Destinations",
      tags: ["Amsterdam", "Week-end", "Canaux", "Musées"],
      readTime: "6 min",
